...
public class AuthorVectorizer {
    ...
    public void run()
    {
        ...
        System.out.println("    Avg Word Length = " + a);
        double b = computeDifferentWordRatio(words);
        System.out.println("    Diff word Ratio = " + b);
        double c = computeHapaxLegomenaRatio(words);
        System.out.println("    Hapax legomanana ratio = " + c);
        double d = computeAverageWordsPerSentence(sentences);
        System.out.println("    Avg words per sentence = " + d);
        double e = computeSentenceComplexity(sentences);
        System.out.println("    Sentence complexity = " + e);
        ...
        for (AuthorSignature author:authors){
            ...
            System.out.println(author.getName() + ": " + score);
        }

        System.out.println();
        System.out.println("Predicted author = " + champName);
